...
public class StartScreen implements Screen {
    ...
    public void show() {
        ...
        Texture backgroundTexture = new Texture("Backgrounds/startscreen.png");
        ...
        Texture nimbleNimbusLogoTexture = new Texture("MainAssets/NimbleNimbus.png");
        ...
        startButton.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                Image blackScreen = new Image(new TextureRegionDrawable(new TextureRegion(new Texture("Backgrounds/black.jpeg"))));
